# nixos/config/home/swaylock.nix
{
  ...
  # Stylix Base16 colors without leading '#' (swaylock expects plain hex strings)
...
in {
  ...
  programs.swaylock = {
    ...
    settings = {
      ...
      # ── Stylix Color Palette Integration (RRGGBB / RRGGBBAA) ─────────────
      # Text Colors
      text-color = "${c.base05}";
      ...
      ring-color = "${c.base0D}AA"; # Accent Blue (70% opacity)
